...
const events: TimelineEvent[] = [
  {
    ...
    description: 'O dia em que nossos caminhos se cruzaram. O início de uma história de amor.',
    icon: <Ring size={22} className="text-rose-500" />,
  },
  {
    date: '28 Abr 2025',
    title: 'Começamos a Namorar',
    description: 'O dia em que oficializamos o que já sentíamos. O dia mais especial da nossa história. Boatos de que o Brito se lembra de terem começado a namorar no dia 14, mas enfim',
  ...
  },
  {
    date: '28 Jun 2025',
    title: '2 Meses',
    description: 'O amor só crescia. Já sabíamos que era algo que valia a pena.',
    icon: <Sun size={22} className="text-amber-400" />,
  },
  {
    date: '28 Jul 2025',
    title: '3 Meses',
    description: 'Três meses de parceria, risadas e muita cumplicidade.',
    icon: <Butterfly size={22} className="text-violet-400" />,
  },
  {
    date: '28 Abr 2026',
    title: '1 Ano de Namoro!',
    description: '365 dias de amor, risadas, parceria e muita cumplicidade.',
    icon: <Cake size={22} className="text-rose-400" />,
  },
  {
    date: '28 Jul 2026',
    title: '1 Ano e 3 Meses',
    description: 'E o melhor ainda está por vir. Te amo mais a cada dia!',
